...
DEFINE_BPF_PROG_KVER(schedcls, tether_downstream6_ether, 4_9, AID_NETWORK_STACK, 4_9)
(struct __sk_buff* skb) {
    return do_forward6(skb, ETHER, DOWNSTREAM, KVER_4_9);
}

DEFINE_BPF_PROG_KVER(schedcls, tether_upstream6_ether, 4_9, AID_NETWORK_STACK, 4_9)
(struct __sk_buff* skb) {
...
DEFINE_BPF_PROG_KVER(schedcls, tether_downstream6_rawip, 4_14, AID_NETWORK_STACK, 4_14)
(struct __sk_buff* skb) {
    return do_forward6(skb, RAWIP, DOWNSTREAM, KVER_4_14);
}

DEFINE_BPF_PROG_KVER(schedcls, tether_upstream6_rawip, 4_14, AID_NETWORK_STACK, 4_14)
(struct __sk_buff* skb) {
